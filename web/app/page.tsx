    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="relative h-[600px] md:h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 drop-shadow-2xl animate-fade-in-up font-display tracking-tight">
            Encuentra tu <span className="text-amber-500">Hogar Ideal</span> en el Soconusco
          </h1>
          <p className="text-xl md:text-2xl text-slate-200 mb-10 max-w-3xl mx-auto drop-shadow-md animate-fade-in-up delay-200 font-light leading-relaxed">

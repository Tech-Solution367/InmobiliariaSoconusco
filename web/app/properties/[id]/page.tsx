...
async function getProperty(id: string) {
  ...
  try {
    ...
    return {
      ...
      // Ensure nested objects are plain objects if necessary, though lean() usually handles it.
      // Mongoose subdocuments might need to be converted if not using lean() fully or if they have methods.
        ...
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="p-8 lg:p-12 flex flex-col h-full">
              ...
              <div className="prose max-w-none mb-8 text-gray-700 flex-grow">
                <h3 className="text-xl font-bold text-slate-900 mb-3 border-b pb-2">Descripción</h3>
          ...
          {(property.video || property.view360) && (
            <div className="p-8 bg-slate-50 border-t border-gray-200">
              <h2 className="text-2xl font-bold text-slate-900 mb-6 text-center">Recorrido Virtual</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {property.video && (
                  <div>
                    <h3 className="flex items-center text-xl font-semibold mb-4 text-slate-700">
                      <FaVideo className="mr-2" /> Video del Inmueble
                    </h3>
                ...
                {property.view360 && (
                  <div>
                    <h3 className="flex items-center text-xl font-semibold mb-4 text-slate-700">
                      <FaStreetView className="mr-2" /> Vista 360°
                    </h3>

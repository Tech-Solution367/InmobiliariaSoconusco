    ...
    <footer className="bg-slate-900 text-white pt-12 pb-8 border-t border-slate-800">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-300 mb-4 leading-relaxed">
              Tu mejor opción para encontrar el hogar de tus sueños o la inversión perfecta en la región del Soconusco.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-amber-500">Enlaces Rápidos</h3>
            <ul className="space-y-2">
              <li><Link href="/" className="text-slate-300 hover:text-amber-400 transition-colors">Inicio</Link></li>
              <li><Link href="/ventas" className="text-slate-300 hover:text-amber-400 transition-colors">Ventas</Link></li>
              <li><Link href="/rentas" className="text-slate-300 hover:text-amber-400 transition-colors">Rentas</Link></li>
              <li><Link href="/contact" className="text-slate-300 hover:text-amber-400 transition-colors">Contactos</Link></li>
            </ul>
          </div>

          {/* Contact & Social */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-amber-500">Contáctanos</h3>
            ...
            <h4 className="text-lg font-semibold mb-3 text-white">Síguenos</h4>
        ...
        <div className="border-t border-slate-800 pt-8 text-center text-slate-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Inmobiliaria Soconusco. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
